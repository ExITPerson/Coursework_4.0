...
from mailing.views import (HomeTemplateView, RecipientListView, RecipientDetailsView,
                           RecipientDeleteView, RecipientCreateView, RecipientUpdateView,
                           MessageListView, MessageDetailsView, MessageDeleteView,
                           MessageCreateView, MessageUpdateView, MailingListView,
                           MailingDetailsView, MailingDeleteView, MailingCreateView,
                           MailingUpdateView, MailingSendView, BaseUserView, MailingDisableView)
...
urlpatterns = [
    ...
    path('recipients_list/', cache_page(60)(RecipientListView.as_view()), name='recipients_list'),
    ...
    path('users/', cache_page(60)(BaseUserView.as_view()), name='user_list'),
]
