...
urlpatterns = [
    ...
    path('recipients_list/', cache_page(60*15)(RecipientListView.as_view()), name='recipients_list'),
    path('recipient_details/<int:pk>/', cache_page(60)(RecipientDetailsView.as_view()), name='recipient_details'),
    ...
    path('message_list/', cache_page(60*15)(MessageListView.as_view()), name='message_list'),
    path('message_details/<int:pk>/', cache_page(60)(MessageDetailsView.as_view()), name='message_details'),
    ...
    path('mailing_list/', cache_page(60*15)(MailingListView.as_view()), name='mailing_list'),
    path('mailing_details/<int:pk>', cache_page(60)(MailingDetailsView.as_view()), name='mailing_details'),
    ...
    path('mailing_details/<int:pk>/send/', cache_page(60)(MailingSendView.as_view()), name='mailing_send'),
    path('mailing/<int:pk>/disable/', MailingDisableView.as_view(), name='mailing_disable'),

    path('users/', cache_page(60*15)(BaseUserView.as_view()), name='user_list'),
]